...
/**
 * Created by toburi on 27/11/2015.
 * Creado por toburi el 27/11/2015.
 */
    ...
    public static void radixSortA( String [ ] arr, int stringLen ) {
        ...
        for( int pos = stringLen - 1; pos >= 0; pos-- ) {
            ...
            for( ArrayList<String> thisBucket : buckets ) {
                for( String s : thisBucket ) arr[ idx++ ] = s;
...
*/
    public static void main( String [ ] args ) {
        ...
        for( int i = 0; i < 100000; i++ ) {
            ...
            for( int j = 0; j < len; j++ ) str += (char) ( 'a' + r.nextInt( 26 ) );
            lst.add( str );
        }
...
//            if( !arr1[ i ].equals( arr2[ i ]  ) ) System.out.println( "OOPS!!" );
//        }
