...
Material::Material(const std::string & lib, const std::string & name) :
	m_library(lib),
	m_name(name),
...
const Vector3 &Material::getAmbient() const { return m_ambient; }
...
void Material::setAmbient(const Vector3 &rgb) { m_ambient = rgb; }
